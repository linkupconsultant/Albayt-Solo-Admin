...
const CardPaket = ({paketID, img, title}: cardProps) => {
  return (
    <div key={paketID} className='flex flex-col justify-between bg-white h-[19rem] rounded-lg shadow-md border duration-500 hover:shadow-xl'>
      <div>
        <img src={img} alt='foto-paket' className='h-40 w-full object-cover rounded-t-lg' />
        <h1 className='font-semibold text-[14px] text-center my-3 mx-6'>{title}</h1>
      </div>
