...
const Sidebar_Alt = () => {
  ...
  return (
    <>
        <div className={`bg-[#f14310] h-screen p-6 pt-8 w-72 relative duration-300 ${open ? 'w-72' : 'w-20 p-0'}`}>
            ...
            <div className='mt-4'>
                <ul className='font-bold text-lg text-white'>
                    <Link href={'/'}>
                        <li className={`py-3 flex gap-3 items-center duration-200 hover:bg-black hover:bg-opacity-15 rounded-lg ${!open && 'justify-center'}`}>
